...
LAYER_CONFIGS = {
    "pm25": {
        "download": {
            "note": "PM2.5 now uses Open-Meteo API - download is part of process stage",
            "skip": True,
            "output_dir": "data/processing/pm25",
        },
        "process": {
            "module": "data_pipeline.processing.openmeteo.process_all_layers",
            "output_dir": "data/processing/pm25",
        },
        "tiles": {
            "note": "Tiles are generated by process_all_layers during process stage",
            "skip": True,
    ...
    "precipitation": {
        "download": {
            "note": "Precipitation now uses Open-Meteo API - download is part of process stage",
            "skip": True,
            "output_dir": "data/processing/precipitation",
        },
        "process": {
            "module": "data_pipeline.processing.openmeteo.process_all_layers",
            "output_dir": "data/processing/precipitation",
    ...
    "uv": {
        "download": {
            "note": "UV now uses Open-Meteo API - download is part of process stage",
            "skip": True,
            "output_dir": "data/processing/uv",
        },
        "process": {
            "module": "data_pipeline.processing.openmeteo.process_all_layers",
            "output_dir": "data/processing/uv",
